...
//         <ParanormalWord x="98.5" y="0" direction="column">ed pretium, enim ut tempus sodales, lectus</ParanormalWord>
//       </div>
//       <style jsx>{`
//         div{
      ...
      <>
        ...
        <Box
          styleSheet={{
            ...
            backgroundColor: 'transparent', width: '100vw', height: '100vh', backgroundImage: 'url(./images/simbolo_transcender.png)',
            backgroundRepeat: 'no-repeat', backgroundBlendMode: 'multiply', backgroundPosition: 'center center', backgroundSize: '500px 500px',
          }}
        >
          <Box
            styleSheet={{
